...
| statement       | notation in paper                 | name in our Agda                                          | file                                             | notes                                                                                                                                                              |
|-----------------|-----------------------------------|-----------------------------------------------------------|--------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Section 1       | contribution: a map of languages  |                                                           | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
| Section 2       | running example                   |                                                           | src/Test/Experiments/RoundTrip.agda              |                                                                                                                                                                    | -- TODO(pmbittner) This is kind of a wild link, I'm on the edge of dropping this row. What do you think?
| Table 1         |                                   |                                                           | src/Lang/All/Generic.agda                        | This file only reexports the language definitions. Use the go-to-definition functionality of your editor for easy exploration.                                     |
|                 | Core Choice Calculus              | CCC                                                       | src/Lang/CCC.lagda.md                            |                                                                                                                                                                    |
|                 | Binary Choice Calculus            | 2CC                                                       | src/Lang/2CC.lagda.md                            |                                                                                                                                                                    |
|                 | Algebraic Decision Trees          | ADT                                                       | src/Lang/ADT.agda                                |                                                                                                                                                                    | -- TODO NADT uses different constructor names than in the paper
|                 | Gruler's Language                 | Gruler                                                    | src/Lang/Gruler.agda                             |                                                                                                                                                                    | -- TODO different constructor names than in the paper
|                 | Option Calculus                   | WFOC, OC                                                  | src/Lang/OC.lagda.md                             | In contrast to the paper, WFOC duplicates the artifact constructor to enforce the existence of a top-level artifact.                                               |
|                 | Feature Structure Trees           | FST                                                       | src/Lang/FST.agda                                |                                                                                                                                                                    |
| Definition 4.1  | Indexed Set                       | IndexedSet                                                | src/Data/IndexedSet.lagda.md                     |                                                                                                                                                                    |
| Definition 4.3  | Indexed Set Inclusion ⋿           | _∈_                                                       | src/Data/IndexedSet.lagda.md                     |                                                                                                                                                                    |
|                 | Subset ⊑                          | _⊆_, _⊆[_]_                                               | src/Data/IndexedSet.lagda.md                     | In contrast to _⊆_, _⊆[_]_ requires an explicit mapping between the indices of the two indexed sets which can be useful information.                               |
|                 | Equivalence ≅                     | _≅_, _≅[_][_]_                                            | src/Data/IndexedSet.lagda.md                     | The difference between _≅_ and _≅[_][_]_ is the same as between _⊆_ and _⊆[_]_.                                                                                    |
| Corollary 4.5   | ⊑ is a partial order              | ⊆-IsIndexedPartialOrder, ⊆[]-refl, ⊆[]-antisym, ⊆[]-trans | src/Data/IndexedSet.lagda.md                     |                                                                                                                                                                    |
|                 | ≅ is an equivalence relation      | ≅-IsIndexedEquivalence, ≅[]-refl, ≅[]-sym, ≅[]-trans      | src/Data/IndexedSet.lagda.md                     |                                                                                                                                                                    |
...
| Definition 4.8  | Non-empty Indexed Set             |                                                           |                                                  | We only need finite and non-empty indexed sets and do not define non-empty indexed sets separately.                                                                |
| Definition 4.9  | Variant Map                       | VMap                                                      | src/Framework/VariantMap.agda                    | This is the finite and non-empty indexed set definition mentioned above.                                                                                           |
| Definition 4.10 | Semantic Domain                   | VMap                                                      | src/Framework/VariantMap.agda                    | In contrast to a variant map, the semantic domain is the type of variant maps instead of its elements.                                                             |
| Definition 4.11 | configuration language 𝐶          | 𝕂                                                         | src/Framework/Definitions.agda                   |                                                                                                                                                                    | -- TODO Use C instead of K if constructors are removed completely
| Definition 4.12 | variability language 𝐿            | 𝔼                                                         | src/Framework/Definitions.agda                   |                                                                                                                                                                    |
| Definition 4.13 | ⟦.⟧                               | 𝔼-Semantics                                               | src/Framework/VariabilityLanguage.lagda.md       |                                                                                                                                                                    |
|                 |                                   | VariabilityLanguage                                       | src/Framework/VariabilityLanguage.lagda.md       | VariabilityLanguage is a bundle of 𝔼, 𝕂 and 𝔼-Semantics.                                                                                                           |
| Definition 4.15 | Complete(𝐿)                       | Complete                                                  | src/Framework/Properties/Completeness.lagda.md   |                                                                                                                                                                    |
| Definition 4.16 | Sound(𝐿)                          | Sound                                                     | src/Framework/Properties/Soundness.lagda.md      |                                                                                                                                                                    |
| Definition 4.17 | ⪰                                 | _≽_                                                       | src/Framework/Relation/Expressiveness.lagda.md   |                                                                                                                                                                    |
|                 | ≡                                 | _≋_                                                       | src/Framework/Relation/Expressiveness.lagda.md   |                                                                                                                                                                    |
|                 | ≻                                 | _≻_                                                       | src/Framework/Relation/Expressiveness.lagda.md   |                                                                                                                                                                    |
| Corollary 4.18  | ⪰ is a partial order              | ≽-IsPartialOrder                                          | src/Framework/Relation/Expressiveness.lagda.md   |                                                                                                                                                                    |
|                 | ≡ is an equivalence relation      | ≋-IsEquivalence                                           | src/Framework/Relation/Expressiveness.lagda.md   |                                                                                                                                                                    |
| Definition 4.19 | 𝑀 ⇾ 𝐿                             |                                                           |                                                  | We only model correct compilers.                                                                                                                                   |
| Definition 4.20 | 𝑀 ⇾ 𝐿 correct                     | LanguageCompiler                                          | src/Framework/Compiler.agda                      |                                                                                                                                                                    |
| Theorem 4.21    | 𝑀 ⇾ 𝐿 ⇒ 𝐿 ⪰ 𝑀                     | expressiveness-from-compiler                              | src/Framework/Relation/Expressiveness.lagda.md   |                                                                                                                                                                    |
| Theorem 4.22    | Complete(M) ∧ L ≽ M ⇒ Complete(L) | completeness-by-expressiveness                            | src/Framework/Proof/Transitive.lagda.md          |                                                                                                                                                                    |
| Theorem 4.23    | Sound(L) ∧ L ≽ M ⇒ Sound(M)       | soundness-by-expressiveness                               | src/Framework/Proof/Transitive.lagda.md          |                                                                                                                                                                    |
| Theorem 4.24    | Complete(L) ∧ Sound(M) ⇒ L ≽ M    | expressiveness-by-completeness-and-soundness              | src/Framework/Proof/Transitive.lagda.md          |                                                                                                                                                                    |
| Figure 3        |                                   |                                                           | src/Translation/LanguageMap.lagda.md             | This file mostly reexports expressiveness results and applies transitivity and the above theorems. It serves as a nice entry point to explore most of our results. |
| Theorem 5.1     | 𝑛-CC                              | NCC                                                       | src/Lang/NCC.lagda.md                            |                                                                                                                                                                    |
|                 | 𝑛-CC ⪰ CCC                        | NCC≽CCC                                                   | src/Translation/Lang/CCC-to-NCC.agda             |                                                                                                                                                                    |
|                 | clamp                             | Exact.translate                                           | src/Translation/Lang/CCC-to-NCC.agda             |                                                                                                                                                                    | -- TODO this is not actually a compiler
|                 | shrink₂                           | shrinkTo2Compiler                                         | src/Translation/Lang/NCC/ShrinkTo2.agda          |                                                                                                                                                                    |
|                 | grow                              | growCompiler                                              | src/Translation/Lang/NCC/Grow.agda               |                                                                                                                                                                    |
| Theorem 5.3     | ADT ≽ 2CC                         | ADT≽2CC                                                   | src/Translation/Lang/2CC-to-ADT.agda             |                                                                                                                                                                    |
| Corollary 5.5   | CCC ≡ 2CC ≡ ADT ≡ 𝑛-CC            | CCC≋NCC, NCC≋2CC and 2CC≋ADT                              | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
| Theorem 5.6     | Complete(CaO)                     | VariantList-is-Complete                                   | src/Lang/VariantList.lagda.md                    |                                                                                                                                                                    |
| Theorem 5.7     | Sound(CaO)                        | VariantList-is-Sound                                      | src/Lang/VariantList.lagda.md                    |                                                                                                                                                                    |
| Theorem 5.8     | CaO ≽ ADT                         | VariantList≽ADT                                           | src/Translation/Lang/ADT-to-VariantList.agda     |                                                                                                                                                                    |
| Theorem 5.10    | CCC ≽ CaO                         | CCC≽VariantList                                           | src/Translation/Lang/VariantList-to-CCC.lagda.md |                                                                                                                                                                    |
| Corollary 5.11  | CCC is complete and sound         | CCC-is-complete, CCC-is-sound                             | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
|                 | 2CC is complete and sound         | 2CC-is-complete, 2CC-is-sound                             | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
|                 | ADT is complete and sound         | ADT-is-complete, ADT-is-sound                             | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
|                 | 𝑛-CC is complete and sound        | NCC-is-complete, NCC-is-sound                             | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
| Theorem 5.12    | 2CC ≽ OC                          | 2CC≽OC                                                    | src/Translation/Lang/OC-to-2CC.lagda.md          |                                                                                                                                                                    |
| Corollary 5.13  | Sound(OC)                         | OC-is-sound                                               | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
| Theorem 5.14    | ¬Complete(OC)                     | OC-is-incomplete                                          | src/Lang/OC.lagda.md                             |                                                                                                                                                                    |
| Theorem 5.15    | 2CC ≻ OC                          | 2CC≻WFOC                                                  | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
| Theorem 5.16    | ¬Complete(FST)                    | FST-is-incomplete                                         | src/Lang/FST.agda                                |                                                                                                                                                                    |
| Theorem 5.17    | OC ⋡ FST                          | WFOCL⋡FSTL                                                | src/Translation/Lang/FST-to-OC.lagda.md          |                                                                                                                                                                    | -- TODO remove L suffix
| Theorem 5.18    | FST ⋡ OC                          | FSTL⋡WFOCL                                                | src/Translation/Lang/OC-to-FST.agda              |                                                                                                                                                                    | -- TODO remove L suffix, Why are both F's the same
| Corollary 5.19  | FST ⋡ 2CC                         | FST⋡2CC                                                   | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    | -- TODO Why are both F's the same
| Theorem 5.20    | Sound(FST)                        | FST-is-sound                                              | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
|                 | 2CC ≽ FST                         | 2CC≽FST                                                   | src/Translation/LanguageMap.lagda.md             |                                                                                                                                                                    |
