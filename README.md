...
| Section 2       | running example                   |                                                                    | src/Test/Experiments/RoundTrip.agda              |                                                                                                                                                                    |
...
| Definition 4.8  | Non-empty Indexed Set             | `empty`                                                            | src/Data/IndexedSet.lagda.md                     | The library definition is a predicate that ensures an indexed set to be non-empty.                                                                                 |
