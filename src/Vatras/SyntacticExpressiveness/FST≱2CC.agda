...
open FST.Impose ℕ-𝔸 hiding (Unique)
...
big-artifact-≉ : (n i : ℕ) → big-artifact n i FST.≉ big-artifact n (i + 2 ^ n)
...
FST≱2CC zero = ℕ-𝔸 , e₁ zero , λ e₂ e₁≅e₂ → 1≤size2CC e₂
FST≱2CC (suc n) = ℕ-𝔸 , e₁ m , λ e₂ e₁≅e₂ →
  begin-strict
    suc n * sizeFST (e₁ m)
